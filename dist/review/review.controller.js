...
const auth_decoraror_1 = require("../auth/decorators/auth.decoraror");
...
let ReviewController = exports.ReviewController = class ReviewController {
    ...
    async leaveReview(id, dto, userId) {
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, review_dto_1.ReviewDto, Number]),
    __metadata("design:returntype", Promise)
], ReviewController.prototype, "leaveReview", null);
__decorate([
    (0, common_1.UsePipes)(new common_1.ValidationPipe()),
    (0, common_1.Get)('average/:id'),
    __param(0, (0, common_1.Param)('id')),
    __metadata("design:type", Function),
